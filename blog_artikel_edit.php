  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action="proses/blog_artikel_proses_edit.php" method="post" class="form-horizontal">
		  <?php
			...
			<input type="hidden" name="id" value="<?= $id ?>">
              <!-- <div class="box-body"> -->
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
					<select name="kategori" class="form-control">
					  <?php
						$sql = mysqli_query($connect,"SELECT * FROM blog_kategori ORDER BY id DESC");
						while($row = mysqli_fetch_array($sql)){
							if ($row['id'] == $blog['kategori_id']){
								$select = 'selected';
							} else {
								$select = '';
							}
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea type="text" id="editor" name="isi" class="form-control" placeholder="Isi"><?= $blog['isi'] ?></textarea>
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <a href="blog_artikel.php" class="btn btn-default">Cancel</a>
